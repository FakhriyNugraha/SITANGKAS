    ...
    <div class="grid lg:grid-cols-3 gap-4">
        <div class="card lg:col-span-2 space-y-4">
            ...
            <div>
                ...
                <textarea name="scenario_text" rows="4" class="form-textarea" required placeholder="Tulis isi pesan atau skenario seperti yang dilihat user...">{{ old('scenario_text', $case->scenario_text) }}</textarea>
            </div>

            <div>
                <label class="text-sm font-medium block mb-1">Penjelasan untuk User</label>
                <textarea name="tutor_feedback" rows="3" class="form-textarea" required placeholder="Penjelasan mengapa jawaban benar atau salah...">{{ old('tutor_feedback', $case->tutor_feedback) }}</textarea>
            </div>
        ...
        <div class="space-y-4">
            <div class="card">
                ...
                <p class="text-xs text-navy-500 mb-3">Tandai satu pilihan yang benar. Sisanya harus jelas keliru.</p>
            ...
            <div class="card">
                ...
                <p class="text-xs text-navy-500 mb-3">Kata kunci bahaya yang sebaiknya dikenali user dalam alasannya.</p>
